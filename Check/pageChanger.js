...
function handleNavigation(page) {
    try {
        ...
        // DON'T close expanded sidebar - let it stay open for better UX
        // Removed the automatic sidebar closing code
        
        // Navigate based on page
        switch(page) {
            case 'portfolio':
                showComingSoonMessage('Portfolio');
                break;

            case 'staking':
                showComingSoonMessage('Staking');
                break;
